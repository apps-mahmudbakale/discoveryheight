...
$rows = $db->Rows("SELECT * FROM `staff_data` INNER JOIN users USING(user_id) INNER JOIN section USING(section_id) ORDER BY user_id ASC LIMIT 4");
//print_r($rows);
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                      ...
                      <div class="col-md-6  border-success border">
                        ...
                        <br>
                        <img src='barcode.php?codetype=Code128&size=70&text=<?php echo $row['staff_id']; ?>&print=true' align="center" width="500" style="margin: 10px auto 20px; display: block;" alt="">
                      </div>
                      <!-- /.col-md-6 -->

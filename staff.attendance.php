  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Staff Attendance</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        	...
        	<div class="card">
              ...
              <div class="card-body">
                <table id="cards" class="table table-bordered table-striped">
                  ...
                  <?php 
                      $sn = 0;
                      $cards = $db->Rows("SELECT * FROM `staff_data` INNER JOIN users USING(user_id) INNER JOIN section USING(section_id) INNER JOIN staff_attendance USING(staff_id)");

...
$class_id = $values[2];
$student = $values[3];
   $query ="SELECT * FROM applicant INNER JOIN student USING(app_id) INNER JOIN student_score USING(student_id) WHERE student_score.class_id='$class_id' AND admission_number='$student' GROUP BY student_id ORDER BY student.student_id";
   $row = $db->Row($query);
   $row['student_id'];
  ...
  <div class="container-fluid">
    <h2 align="center"><img src="dist/img/logo.png" width="100" height="100"></h2>
      <h2 align="center"> MARYAM QURAN SCHOOLS, GUSAU, ZAMFARA STATE</h2>
        ...
        <p>&nbsp;</p>
        <h4 align='center'>ASSESSMENT SHEET</h4>
                ...
                <tbody>
                  ...
                  foreach($subjects as $s) {
                               ...
                               $TotalMinClass +=$minscore;
                                ...
                                echo '<td align="center" bgcolor="#FDFDFB">'.$all[8].'</td>';
                                echo '</tr>';
                   }
